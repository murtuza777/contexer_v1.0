    ...
    <>
      <div
        className={cn(
          ...
          "scrollbar-thin scrollbar-thumb-neon-green/50 scrollbar-track-transparent",
          "px-2 py-3",
          isDragging && "bg-neon-green/10 border-2 border-dashed border-neon-green/30 rounded-lg"
        )}
        role="tree"
        aria-label="文件浏览器"
