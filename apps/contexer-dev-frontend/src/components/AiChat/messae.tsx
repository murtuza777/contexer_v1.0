      ...
      if (state.insideArtifact) {
        if (state.insideAction) {
          ...
          if (actionCloseMatch) {
            ...
            // Handle file and shell type actions
            if ('type' in state.currentAction) {
              ...
              // Call different callbacks based on action type
              if (state.currentAction.type === 'file') {
                ...
                // Shell type only processed when closing
          ...
          // Find next action start tag or artifact end tag
