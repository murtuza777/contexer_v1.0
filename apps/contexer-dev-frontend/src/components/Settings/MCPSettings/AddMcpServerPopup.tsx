                        ...
                        <div className="flex justify-end gap-3 px-6 py-4 border-t border-gray-200/80 dark:border-gray-700/80">
                            ...
                            <button
                                ...
                                className={classNames(
                                    "px-4 py-2 text-sm font-medium rounded-lg",
                                    "text-white",
                                                    "bg-gradient-to-r from-[#1E90FF] to-[#000080] hover:from-[#4169E1] hover:to-[#000066]",
        ...
        {options.map((option) => (
            <button
                ...
                className={classNames(
                    ...
                    "transition duration-200",
                    value === option.value ? (
                        "bg-blue-100 dark:bg-[#000080]/30 text-[#000080] dark:text-blue-400"
                    ) : (
    ...
    <button
        ...
        className={classNames(
            "relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full transition-colors duration-200 ease-in-out",
                          checked ? "bg-[#000080]" : "bg-gray-200 dark:bg-gray-700"
        )}
    >
        <span
            className={classNames(
