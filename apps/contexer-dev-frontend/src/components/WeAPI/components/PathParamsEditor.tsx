...
function PathParamsEditor({ url, pathParams, onUpdateUrl, onUpdateParams }: PathParamsEditorProps): JSX.Element {
  ...
  // Get actual URL (replace placeholders)
