    ...
    <div className="relative" ref={selectRef}>
      <button
        ...
        className={classNames(
          ...
          "focus:outline-none focus:ring-2 focus:ring-[#000080]/50",
          ...
          {options.map((option) => (
            <button
              ...
              className={classNames(
                ...
                "hover:bg-gray-50 dark:hover:bg-gray-700/50",
                "transition-colors duration-200",
                                  value === option.value && "bg-blue-50 dark:bg-[#000080]/20 text-[#000080] dark:text-blue-400"
              )}
            >
              {option.label}
            </button>
...
const CustomRadio = ({ checked, onChange, children, value }) => (
  <button
    ...
    className={classNames(
      ...
      "transition-colors duration-200",
      checked
                          ? "bg-blue-50 dark:bg-[#000080]/20 text-[#000080] dark:text-blue-400 border-blue-200 dark:border-[#000080]"
  ...
  >
    <div className={classNames(
      ...
      checked
                          ? "border-[#000080] dark:border-blue-400"
        : "border-gray-300 dark:border-gray-600"
    )}>
      {checked && (
        <div className="w-2 h-2 rounded-full bg-[#000080] dark:bg-blue-400" />
      )}
    </div>
    <span>{children}</span>
  </button>
...
// Add custom multiline input component
        ...
        <nav className="border-b border-gray-200 dark:border-gray-700">
          <button
            className={classNames(
              ...
              "focus:outline-none",
              activeTab === 'general'
                ? "border-b-2 border-[#000080] text-[#000080] dark:text-blue-400"
