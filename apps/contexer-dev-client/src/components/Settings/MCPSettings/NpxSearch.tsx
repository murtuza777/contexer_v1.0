            ...
            <div className="space-y-4">
                    ...
                    <button
                        ...
                        className={classNames(
                            "px-4 py-2 text-sm font-medium rounded-lg",
                                            "text-white bg-[#000080] hover:bg-[#000066]",
                "dark:bg-[#000080] dark:hover:bg-[#000066]",
                            "focus:outline-none focus:ring-2 focus:ring-[#000080]/50",
                ...
                {searchLoading ? (
                    <div className="flex justify-center items-center py-12">
                        <div className="animate-spin rounded-full h-8 w-8 border-2 border-[#000080] border-t-transparent" />
                    </div>
                                        ...
                                        <td className="px-2 py-2">
                                            <div className="space-y-1">
                                                ...
                                                <a
                                                    ...
                                                    className="text-sm text-[#000080] hover:text-[#000066] dark:text-blue-400 dark:hover:text-blue-300 block truncate"
