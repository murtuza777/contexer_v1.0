          ...
          {!window.electron && (
            <button
              ...
              className={`flex items-center gap-1.5 px-2.5 py-1.5 text-sm text-white rounded-lg transition-colors ${
                isDeploying 
                                  ? 'bg-gradient-to-r from-[#000060] to-[#000080] opacity-75 cursor-not-allowed'
                : 'bg-gradient-to-r from-[#1E90FF] to-[#000080] hover:from-[#4169E1] hover:to-[#000066] shadow-md'
              }`}
            >
              {isDeploying ? (
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md w-full mx-4 shadow-xl transform transition-all">
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-[#1E90FF] to-[#000080] text-white rounded-lg hover:from-[#4169E1] hover:to-[#000066] transition-all duration-300 flex items-center gap-2 shadow-md"
              >
